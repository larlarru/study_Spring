...
<!-- Left navbar links -->
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="${cp }/member/pagingMember" class="nav-link">HOME</a></li>
				<li class="nav-item d-none d-sm-inline-block"><a href="${cp }/member/pagingMember" class="nav-link">회원관리</a></li>
			</ul>

			<!-- SEARCH FORM -->
			<form class="form-inline ml-3">
				<div class="input-group input-group-sm">
					<input id="common_header_searchInput" class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search">
					<div class="input-group-append">
						<button id="common_header_searchBtn" class="btn btn-navbar" type="submit">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown"><a class="nav-link" data-toggle="dropdown" href="${cp}/memberModify.do"> <i class="far fa-comments"></i> <span class="badge badge-danger navbar-badge">3</span>
				</a>
